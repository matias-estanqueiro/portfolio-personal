...
- **images/**: Carpeta con recursos gráficos utilizados en el sitio.
- **README.md**: Documentación principal y checklist de requerimientos.
...
- Personalización de estilos para tablas, botones, enlaces y formularios.
- Implementación de animaciones y transiciones para mejorar la experiencia visual.

## Autor
Matias Afonso Estanqueiro

---

> Para más detalles sobre el cumplimiento de los requerimientos, consulta el archivo README.md en la raíz del proyecto.